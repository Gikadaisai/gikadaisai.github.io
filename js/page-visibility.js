...
(function () {
  ...
  function applyComingSoon(config) {
    ...
    var festivalName =
      "第" + config.festivalNumber + "回" + config.festivalName;
    ...
    var html = [
      ...
      '    <p class="c">今年度の技科大祭開催にあたり、多くの企業の皆様にご支援、ご協力を賜りました。<br>心より感謝申し上げます。（敬称略）</p>',
      ...
      '    <p class="c">今年度の技科大祭開催に際し、寄付サイト等を通じてご支援いただいた皆様をご紹介いたします。<br>皆様のご厚志に心より御礼申し上げます。（50音順、敬称略）</p>',
